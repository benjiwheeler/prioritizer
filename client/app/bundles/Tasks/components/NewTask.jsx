...
import {provideInitialState, requestToServer, submitNewTask} from '../TaskActions';
  ...
  render() {
    ...
    return (
      ...
      onSubmit={this.handleSubmit.bind(this)}>
        ...
        <div class='field'>
          <input
          class="initial-focus form-control"
        ...
        <div class='field'>
          ...
          value=""
          />
          <select class="tag_select" multiple="multiple" style="width: 100%"
